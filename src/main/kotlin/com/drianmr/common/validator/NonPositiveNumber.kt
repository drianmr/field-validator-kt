...
/**
 * A class representing a validator for non-positive numbers.
 *
 * This validator ensures that the provided value is a number and has a value less than or equal to zero.
 ...
 * by this validator.
 */
data object NonPositiveNumber : FieldValidator<Number> {
