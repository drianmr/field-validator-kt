...
/**
 * A class representing a validator for strictly positive numbers.
 *
 * This validator ensures that the provided value is a number and has a value
 * greater than zero (no zeros allowed).
 ...
 * by this validator.
 */
data object StrictPositiveNumber : FieldValidator<Number> {
